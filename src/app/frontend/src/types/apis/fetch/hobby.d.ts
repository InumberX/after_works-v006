...
const apiResponseHobbyPageInfo = {
  totalCnt: 1,
  perPage: 20,
  totalPageCnt: 1,
  pageNo: 1,
  firstIndex: 1,
  lastIndex: 1,
  path: '/rcms-api/6/hobby',
  param: '?data_format=json',
  startPageNo: 1,
  endPageNo: 1,
}

const apiResponseHobby = {
  errors: [],
  messages: [],
}

export type ApiResponseHobbyData = typeof apiResponseHobbyList

export type ApiResponseHobbyPageInfo = typeof apiResponseHobbyPageInfo

export type ApiResponseHobby = {
  list: ApiResponseHobbyData[]
  pageInfo: ApiResponseHobbyPageInfo
} & typeof apiResponseHobby
